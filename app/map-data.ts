...
export const maps: MapDefinition[] = [
  { id: 'zone1', name: 'Skyreach', zone: 'Zone 01', image: './maps/zone1-skyreach.png', width: 6528, height: 7680 },
  { id: 'zone2', name: 'Verdant Expanse', zone: 'Zone 02', image: './maps/zone2.png', width: 3840, height: 4608 },
  { id: 'zone3', name: 'Emerald Basin', zone: 'Zone 03', image: './maps/zone3.png', width: 3840, height: 3840 },
];

export const categoryMeta: Record<MarkerCategory, { label: string; icon: string; color: string }> = {
  npc: { label: 'NPCs', icon: '✦', color: '#ffd166' },
  monster: { label: 'Monsters', icon: '◆', color: '#ff6577' },
  portal: { label: 'Portals', icon: '↟', color: '#b69cff' },
  custom: { label: 'Custom', icon: '●', color: '#62d8ff' },
};
